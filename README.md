...
| **gemini-cli**         | 0.35.0                       | AI agent bringing Gemini directly into your terminal.                   | All            |
| **gemini-cli-bin**     | 0.35.0                       | Binary version of Gemini CLI (faster installation).                     | Linux, Darwin  |
| **gh-aw**              | 0.64.1                       | GitHub CLI extension for Actions Workflow management.                   | All            |
| **github-copilot-cli** | 1.0.11                      | Github Copilot coding agent directly in your terminal.                  | All            |
...
| **warp-terminal**      | 0.2026.03.18.08.24.stable_03 | Rust-based terminal reimagined for the 21st century.                    | Linux, Darwin  |
