...
| **gemini-cli**         | 0.27.2                       | AI agent bringing Gemini directly into your terminal.                  | All            |
| **github-copilot-cli** | 0.0.405                      | Github Copilot coding agent directly in your terminal.                 | All            |
...
| **warp-terminal**      | 0.2026.02.04.08.20.stable_02 | Rust-based terminal reimagined for the 21st century.                   | Linux, Darwin  |
