...
| **gh-aw**              | 0.65.7                       | GitHub CLI extension for Actions Workflow management.                     | All            |
| **github-copilot-cli** | 1.0.17                       | Github Copilot coding agent directly in your terminal.                    | All            |
