...
| :------------------------ | :--------------------------- | :---------------------------------------------------------------------------------------------------------- | :------------- |
| **antigravity-cli**       | 1.1.21                        | Official CLI for Antigravity.                                                                               | Linux, Darwin  |
...
| **gh-aw**                 | 0.86.2                       | GitHub CLI extension for Actions Workflow management.                                                       | All            |
| **github-copilot-cli**    | 1.0.80                       | Github Copilot coding agent directly in your terminal.                                                      | All            |
