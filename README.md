...
| :------------------------ | :--------------------------- | :---------------------------------------------------------------------------------------------------------- | :------------- |
| **antigravity-cli**       | 1.0.14                        | Official CLI for Antigravity.                                                                               | Linux, Darwin  |
...
| **gh-aw**                 | 0.81.6                       | GitHub CLI extension for Actions Workflow management.                                                       | All            |
| **github-copilot-cli**    | 1.0.67                       | Github Copilot coding agent directly in your terminal.                                                      | All            |
...
| **warp-terminal**         | 0.2026.06.24.09.19.stable_03 | Rust-based terminal reimagined for the 21st century.                                                        | Linux, Darwin  |
