...
| :------------------------ | :--------------------------- | :---------------------------------------------------------------------------------------------------------- | :------------- |
| **antigravity-cli**       | 1.1.2                        | Official CLI for Antigravity.                                                                               | Linux, Darwin  |
...
| **github-copilot-cli**    | 1.0.70                       | Github Copilot coding agent directly in your terminal.                                                      | All            |
...
| **wavebox**               | 150.2.121-2                   | The Wavebox productivity browser.                                                                           | `x86_64-linux` |
