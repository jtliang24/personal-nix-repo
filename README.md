...
| **gemini-cli**         | 0.29.7                       | AI agent bringing Gemini directly into your terminal.                  | All            |
| **gemini-cli-bin**     | 0.29.7                       | Binary version of Gemini CLI (faster installation).                    | Linux, Darwin  |
| **github-copilot-cli** | 0.0.415                      | Github Copilot coding agent directly in your terminal.                 | All            |
