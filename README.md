...
| :------------------------ | :--------------------------- | :---------------------------------------------------------------------------------------------------------- | :------------- |
| **antigravity-cli**       | 1.1.12                        | Official CLI for Antigravity.                                                                               | Linux, Darwin  |
| **antigravity-ide**       | 2.5.4                        | Agentic development platform, evolving the IDE into the agent-first era.                                    | Linux, Darwin  |
| **ArtixGameLauncher**     | 2.20                         | Artix Games Launcher (appimage launcher), packaged for non-NixOS systems.                                   | `x86_64-linux` |
| **gh-aw**                 | 0.85.4                       | GitHub CLI extension for Actions Workflow management.                                                       | All            |
| **github-copilot-cli**    | 1.0.79                       | Github Copilot coding agent directly in your terminal.                                                      | All            |
...
| **wavebox**               | 151.2.154-2                   | The Wavebox productivity browser.                                                                           | `x86_64-linux` |
