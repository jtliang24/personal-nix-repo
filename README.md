...
| :------------------------ | :--------------------------- | :---------------------------------------------------------------------------------------------------------- | :------------- |
| **antigravity-cli**       | 1.2.9                        | Official CLI for Antigravity.                                                                               | Linux, Darwin  |
...
| **github-copilot-cli**    | 1.0.88                       | Github Copilot coding agent directly in your terminal.                                                      | All            |
...
| **wavebox**               | 154.3.2-2                   | The Wavebox productivity browser.                                                                           | `x86_64-linux` |
