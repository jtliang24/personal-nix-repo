...
| **gh-aw**              | 0.65.5                       | GitHub CLI extension for Actions Workflow management.                   | All            |
| **github-copilot-cli** | 1.0.15                      | Github Copilot coding agent directly in your terminal.                  | All            |
