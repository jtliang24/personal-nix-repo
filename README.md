...
| **gemini-cli**         | 0.29.2                       | AI agent bringing Gemini directly into your terminal.                  | All            |
| **gemini-cli-bin**     | 0.29.2                       | Binary version of Gemini CLI (faster installation).                    | Linux, Darwin  |
