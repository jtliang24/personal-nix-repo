...
| :------------------------ | :--------------------------- | :---------------------------------------------------------------------------------------------------------- | :------------- |
| **antigravity-cli**       | 1.1.9                        | Official CLI for Antigravity.                                                                               | Linux, Darwin  |
...
| **gh-aw**                 | 0.83.4                       | GitHub CLI extension for Actions Workflow management.                                                       | All            |
| **github-copilot-cli**    | 1.0.77                       | Github Copilot coding agent directly in your terminal.                                                      | All            |
