...
| :--------------------- | :--------------------------- | :------------------------------------------------------------------------ | :------------- |
| **antigravity-cli**    | 1.0.7                        | Official CLI for Antigravity.                                             | Linux, Darwin  |
...
| **gh-aw**              | 0.79.4                       | GitHub CLI extension for Actions Workflow management.                     | All            |
...
| **warp-terminal**      | 0.2026.06.03.09.49.stable_03 | Rust-based terminal reimagined for the 21st century.                      | Linux, Darwin  |
