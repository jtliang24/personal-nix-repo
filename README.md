...
| :------------------------ | :--------------------------- | :---------------------------------------------------------------------------------------------------------- | :------------- |
| **antigravity-cli**       | 1.1.10                        | Official CLI for Antigravity.                                                                               | Linux, Darwin  |
...
| **github-copilot-cli**    | 1.0.78                       | Github Copilot coding agent directly in your terminal.                                                      | All            |
...
| **wavebox**               | 151.2.148-2                   | The Wavebox productivity browser.                                                                           | `x86_64-linux` |
