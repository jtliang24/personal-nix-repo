...
| :------------------------ | :--------------------------- | :---------------------------------------------------------------------------------------------------------- | :------------- |
| **antigravity-cli**       | 1.1.4                        | Official CLI for Antigravity.                                                                               | Linux, Darwin  |
...
| **gh-aw**                 | 0.82.13                       | GitHub CLI extension for Actions Workflow management.                                                       | All            |
| **github-copilot-cli**    | 1.0.71                       | Github Copilot coding agent directly in your terminal.                                                      | All            |
...
| **wavebox**               | 150.2.131-2                   | The Wavebox productivity browser.                                                                           | `x86_64-linux` |
