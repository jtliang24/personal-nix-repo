...
- **Root-level `.nix` files**: Individual package definitions (e.g., `gh-aw.nix`, `wavebox.nix`).
...
- **All platforms**: `antigravity-cli`, `gh-aw`, `github-copilot-cli`, `warp-terminal`, `neovimConfigured`.
